(async function () {
    ...
    const createRedirectBot = () => {
        var redirect = new Bot(
            {
                name: "redirect", 
                entrypoint: 'main', 
                keyword: "@redirect",
        ...
        redirect.addLocationInterceptor('main', () => {
            const menu = {
                name: 'main',
                title: "Welcome",
                message: "Select an option",
                options: [
                    {key: 1, label: "consult", menu: "consult", goto: "consult"},
                    {key: 2, label: "book", menu: "book", goto: "book"},
                ]
            }
    ...
    const createOptionsBot = () => {
        ...
        info.addLocationInterceptor('*', function(request, tags, ctxt){
            ...
            console.log(ctxt.bot.getAppContext());
        });
