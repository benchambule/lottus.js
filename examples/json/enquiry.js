...
(async function () {
    ...
    console.log({msisdn: "123", prompt: "Ben Chambule"}, await bot.process({msisdn: "123", prompt: "Ben Chambule"}));
    console.log({msisdn: "123", prompt: "23/04/1994"}, await bot.process({msisdn: "123", prompt: "23/04/1994"}));

    console.log("---------------------------------------------------------------");
    console.log({msisdn: "123", prompt: "@bot"}, await bot.process({msisdn: "123", prompt: "@bot"}));
    console.log({msisdn: "123", prompt: "1"}, await bot.process({msisdn: "123", prompt: "1"}));
    console.log({msisdn: "123", prompt: "0"}, await bot.process({msisdn: "123", prompt: "0"}));
})();